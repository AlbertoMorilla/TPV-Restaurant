...
def total():
    ...
    for cantidad in texto_postres:
        sub_total_postres = sub_total_postres + (float(cantidad.get()) * precios_comida[p])
        p += 1
...
def guardar():
    ...
    archivo.close()
    messagebox.showinfo('Informacion', 'Su recibo se ha guardado correctamente')
...
aplicacion.geometry('1230x630+0+0')
...
# Lista de productos
lista_comidas = ['pollo', 'pescado', 'salmon', 'merluza', 'croquetas', 'lagrimitas', 'adobo', 'hamburguesa']
lista_bebidas = ['cerveza', 'Cerveza0%', 'refresco', 'agua', 'zumo', 'Ribera', 'Rioja', 'Cubata']
lista_postres = ['arroz con leche', 'natillas', 'flan', 'yogurt', 'helado', 'fruta', 'tarta de queso', 'Mousse']
